                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b border-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            <th className="px-8 py-6">{activeTab === 'low-stock' ? 'Nama Barang' : 'Transaksi'}</th>
                            <th className="px-6 py-6">{activeTab === 'low-stock' ? 'Status' : 'Jumlah & Kategori'}</th>
                            <th className="px-6 py-6">{activeTab === 'low-stock' ? 'Stok' : 'Waktu'}</th>
                            ...
                            lowStockItems.length > 0 ? (
                                lowStockItems.map((product) => (
                                    <tr key={product.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-5 text-gray-900 font-bold">{product.jumlah} pcs</td>
                                        <td className="px-6 py-5 text-right">
                                            <Link href="/dashboard/products" className="text-gray-400 hover:text-indigo-600 font-medium text-sm">
                                                Update Stok
                                            </Link>
                                        </td>
                                    </tr>
                            ...
                            recentSales.length > 0 ? (
                                recentSales.map((sale) => (
                                    <tr key={sale.id} className="hover:bg-gray-50/50 transition-colors">
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="font-bold text-gray-900">{sale.nama}</span>
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col">
                                                <span className="text-sm font-bold text-gray-900">{sale.jumlah} items</span>
                                        ...
                                        <td className="px-6 py-5 text-right">
                                            <Link href="/dashboard/sales" className="text-gray-400 hover:text-indigo-600 font-medium text-sm">
                                                Lihat Detail
                                            </Link>
                                        </td>
                                    </tr>
